...
class PostDAO {
    ...
    public function changetoactiveRole($LJRole_ID,$LJRole_Name,$LJRole_Description,$Department,$Key_Task,$LJRole_Status) {
        // STEP 1   
        $connMgr = new ConnectionManager();
        $conn = $connMgr->connect();
    ...
    public function changetoActiveSkill($Skill_ID,$Skill_Name,$Type_of_Skills,$Level_of_Competencies,$Skill_Status) {
        // STEP 1   
        $connMgr = new ConnectionManager();
        $conn = $connMgr->connect();
