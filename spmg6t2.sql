...
CREATE TABLE IF NOT EXISTS `learning_journey` (
    ...
    `Staff_ID` int NOT NULL,
    `Skill_SubmittedLJRole_ID` int NOT NULL,
    `Skill_ID`int(5) NOT NULL,
    `Submitted_CourseID` varchar(20) NOT NULL,
    PRIMARY KEY (`LJ_ID`),
    FOREIGN KEY (`Staff_ID`) REFERENCES staff(`Staff_ID`),
    FOREIGN KEY (`Submitted_CourseID`) REFERENCES course(`Course_ID`),
    FOREIGN KEY (`Skill_SubmittedLJRole_ID`) REFERENCES ljroles(`LJRole_ID`),
    FOREIGN KEY (`Skill_ID`) REFERENCES skills(`Skill_ID`)
...
--
INSERT INTO  `learning_journey` (`LJ_ID`, `Staff_ID`,  `Skill_SubmittedLJRole_ID`,`Skill_ID`,`Submitted_CourseID`) VALUES 
