              ...
              <div class="card">
                <img class="card-img-top" src=" ${arrayUniqueByKey[i].LJRole_img} " alt="Card image cap">
                  <div class="card-body">
                    ...
                    <a href="Role_Specific1.html?id=${arrayUniqueByKey[i]['LJRole_ID']}" class="btn btn-primary" id="styled" onClick="populateHeader(${arrayUniqueByKey[i].LJRole_ID})">View More</a>
                  </div>
              </div>
            </div>`
          }
